...
_ESTADOS_EQUIPO      = ["INGRESO_BODEGA", "STOCK", "RESERVADO", "SALIDA_INSTALACION",
                        "INSTALADO_CLIENTE", "REINGRESO_BODEGA", "ACTIVO_EN_CAMPO",
                        "DEVOLUCION_PROVEEDOR", "OBSOLETO"]
_ESTADOS_HERRAMIENTA = ["STOCK", "RESERVADA", "EN_USO", "EN_MANTENIMIENTO", "OBSOLETA"]
_ESTADOS_MATERIAL    = ["STOCK", "RESERVADO", "PARCIALMENTE_USADO", "CONSUMIDO", "OBSOLETO"]
...
_STATE_LABEL = {
    ...
    "OBSOLETA": "DADA DE BAJA", "EN_USO": "EN USO", "EN_MANTENIMIENTO": "EN MANTENIMIENTO",
